...
public class Home extends JFrame implements ActionListener{
	...
	private JPanel contentPane;
        ...
        public Home(String name) {
            ...
            ImageIcon i4  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/Statistics.png"));
            ...
            ImageIcon i7  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/AddStudent.jfif"));
            Image i8 = i7.getImage().getScaledInstance(150, 150,Image.SCALE_DEFAULT);
            ImageIcon i9 = new ImageIcon(i8);
            l4 = new JLabel(i9);
            l4.setBounds(505, 140, 225, 152);
            contentPane.add(l4);
            ...
            b8 = new JButton("Book Details");
            b8.addActionListener(this);
            b8.setBackground(Color.BLACK);
            b8.setForeground(Color.WHITE);
            b8.setBounds(780, 620, 159, 41);
            contentPane.add(b8);

            JLabel l5 = new JLabel("");
            ImageIcon i10  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/IssueBook.png"));
            ...
            ImageIcon i13  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/ReturnBook.jfif"));
            ...
            ImageIcon i19  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/SearchStudent.png"));
            Image i20 = i19.getImage().getScaledInstance(150, 150,Image.SCALE_DEFAULT);
            ImageIcon i21 = new ImageIcon(i20);
            l8 = new JLabel(i21);
            l8.setBounds(762, 140, 197, 150);
            contentPane.add(l8);
            
            JLabel l9 = new JLabel("");
            ImageIcon i110  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/books.png"));
            Image i22 = i110.getImage().getScaledInstance(150, 150,Image.SCALE_DEFAULT);
            ImageIcon i23 = new ImageIcon(i22);
            l9 = new JLabel(i23);
            l9.setBounds(785, 440, 197, 150);
            contentPane.add(l9);
